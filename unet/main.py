...
image_datagen = image.ImageDataGenerator(height_shift_range=0.1, horizontal_flip=True ,rotation_range=25 ,width_shift_range=0.1 ,shear_range=0.2, vertical_flip=True, fill_mode='reflect')
mask_datagen = image.ImageDataGenerator(height_shift_range=0.1, horizontal_flip=True ,rotation_range=25 ,width_shift_range=0.1 ,shear_range=0.2, vertical_flip=True, fill_mode='reflect')
...
model2.summary()# Fit model
earlystopper = EarlyStopping(patience=5, verbose=1)
checkpointer = ModelCheckpoint('model-dsbowl2018-1.h5', verbose=1, save_best_only=True)
results = model.fit_generator(train_generator, validation_data=val_generator, validation_steps=10, steps_per_epoch=666,
                              epochs=66, callbacks=[earlystopper, checkpointer])
...
sub.to_csv('sub000.csv', index=False)
